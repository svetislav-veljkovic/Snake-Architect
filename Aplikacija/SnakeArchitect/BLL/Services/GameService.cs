...
namespace BLL.Services
{
    public class GameService : IGameService
    {
        ...
        public async Task<(bool Success, string Message, RollDiceResult? Result)> RollDiceAsync(int roomId, int userId)
        {
            ...
            if (connectedPlayerCount < room.MinPlayers)
                return (false, "Partija je pauzirana dok se ne prikljuci dovoljan broj igraca.", null);
        ...
        public async Task<object?> GetGameStateAsync(int roomId)
        {
            ...
            return new
            {
                ...
                RequiredPlayerCount = room.MinPlayers,
